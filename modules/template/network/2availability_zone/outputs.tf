...
output "subnet_private_1a_2az_cidr_block" {
  value = aws_subnet.private_1a_2az.cidr_block
}

output "subnet_private_1c_2az_cidr_block" {
  value = aws_subnet.private_1c_2az.cidr_block
}